pkgname=gittyup-git
pkgver=1.3.0.r126.g71da998
pkgrel=1
pkgdesc="Graphical Git client (GitAhead fork)"
url="https://github.com/Murmele/Gittyup"
arch=('loong64' 'x86_64')
license=(MIT)
depends=(qt5-base hunspell lua cmark pcre libssh2 libgit2)
...
provides=(gittyup)
conflicts=(gittyup)
source=("git+https://hub.njuu.cf/Murmele/Gittyup.git"
        "stinb-libgit2::git+https://hub.njuu.cf/stinb/libgit2.git"
        "git+https://hub.njuu.cf/kuba--/zip.git"
        "git+https://hub.njuu.cf/ScintillaOrg/lexilla.git"
        "git+https://hub.njuu.cf/orbitalquark/scintillua.git")
sha256sums=('SKIP'
            'SKIP'
            'SKIP'
            'SKIP'
